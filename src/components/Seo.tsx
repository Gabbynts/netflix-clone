...
const defaultMeta = {
  ...
  description:
    'Netflix Clone built using NextJs, TypeScript, and Tailwind',
  url: 'https://netflix.gabriellanatasya.website/',
  type: 'website',
  robots: 'follow, index',
  /**
...
export default function Seo(props: SeoProps) {
  ...
  return (
    <Head>
      ...
      <meta name='netflix:title' content={meta.title} />
      <meta name='netflix:description' content={meta.description} />
      <meta name='netflix:image' content={meta.image} />
      {meta.date && (
        <>
