      ...
      <ReactPlayer
        ...
        <div className='absolute bottom-10 left-9'>
          <div className='flex space-x-3'>
            ...
            <button className='border-white border-2 !z-30 h-9 w-9 bg-[#0e0d0d]/75 rounded-full flex justify-center hover:bg-[#333]/75'>
              <AiOutlinePlus className='w-6 h-6 absolute top-[5.5px]'/>
            </button>

            <button className='border-white border-2 !z-30 h-9 w-9 bg-[#0e0d0d]/75 rounded-full flex justify-center hover:bg-[#333]/75'>
              <BiLike className='h-6 w-6 absolute top-[5.5px]'/>
            </button>
        </div>
</div>
