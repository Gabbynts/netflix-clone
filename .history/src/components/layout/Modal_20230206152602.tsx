      ...
      <ReactPlayer
        ...
        <div className='absolute bottom-10 left-9'>
          <div className='flex space-x-3'>
            ...
            <button className='border-white border-2 !z-30 h-8 w-8 bg-[#0e0d0d]/75 rounded-full flex justify-center hover:bg-[#333]/75'>
              <AiOutlinePlus className='w-6 h-6 absolute top-1'/>
            </button>

            <button className='border-[#6d6d6d] hover:border-[#ffffff] border-2 !z-30 h-8 w-8 bg-[#0e0d0d]/75 rounded-full flex justify-center hover:bg-[#333]/75'>
